...
class Player:
    ...
    def move(self, direction, level, interface):
        ...
        Args:
            direction (int): The direction to move (K_LEFT, K_RIGHT, K_UP, K_DOWN).
            level (Level): The level object.
            interface (PlayerInterface): The player interface object.
    ...
    def render(self, window, textures):
        """
        Renders the player on the game window.

        Args:
            window (pygame.Surface): The game window surface.
            textures (dict): A dictionary mapping texture names to pygame.Surface objects.
